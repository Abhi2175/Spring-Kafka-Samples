...
public class LibraryEventsControllerIntegrationTest {
  ...
  void setUp() {
    Map<String, Object> configs =
        new HashMap<>(KafkaTestUtils.consumerProps("kafka-group", "true", embeddedKafkaBroker));
    consumer =
  ...
  void postLibraryEvent() {
    ...
    String expectedRecord =
        "{\"libraryEventId\":null,\"libraryEventType\":\"NEW\",\"book\":{\"bookId\":123,\"bookName\":\"Kafka using Spring Boot\",\"bookAuthor\":\"Abhishek\"}}";
